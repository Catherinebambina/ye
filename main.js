...
function draw(){
    ...
    song_TEEN_TITAN = TEEN_TITAN_SONG.isPlaying();
    console.log(song_TEEN_TITAN);
    ...
    if(scoreleftWrist > 0.2){
        ...
        if(song_Peter_pan == false){
           TEEN_TITAN_SONG.play();
        }
        else{
            console.log("Song Name: TEEN TITANN");
            document.getElementById("song_id").innerHTML = "Song Name: Teen Titan Song";
        }
    }
